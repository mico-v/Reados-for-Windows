...
They currently cover MSP parser/runtime behavior, audit records, streaming command events, transcript progress state, durable session records, artifact provenance manifests, app virtual workspace projections, approval-gated host commands, and chat command persistence. New MSP work should add tests close to the layer being changed:
...
- session/transcript tests for grouping, progress/cancel state, and stale record cleanup surfaced in the workbench;
